...
<div>
    ...
    <div class="container text-center"  >         
        <div className="row row-cols-2  grid-container  " >
            ...
            <div className="col text-start col-md-6 col-sm-12 col-lg-6 " style={{fontSize:'12px',lineHeight:'27px', maxWidth:'350px', }}>
              ...
              style={{color:'#00821C',marginTop:'30px',fontSize:'18px',}}>
                Moshie Zongo Development Organization</h5>
              ...
              <button className="btn btn-primary" style={{marginTop:'20px'}}>READ MORE</button>
                ...
                {/* first colume dive with img and text End */}
    ...
    <div class="container">
        ...
        <div className="row row-cols-4  card-col  justify-content-center align-items-center  ">
    ...
    <div className='text-center container-fluid mt-5  d-flex justify-content-center align-items-center text-light  mx-auto' 
          ...
          style={{width:'2rem',}}/>
                ...
                <p className="inline-p" >
                  <i class="bi bi-heart"></i> <br /> 2000 <br /> Live touched
                </p>
              
                <p className="inline-p m-5">
                    <i class="bi bi-people-fill"></i> <br /> 0 <br /> partner  
                  </p>
    </div>
      {/* programme lineup grid container start */}

    <div className="row row-cols-4  card-col container-fluid justify-content-center align-items-center  ">
      ...
      <div className='text-center container-fluid mt-5  d-flex justify-content-center align-items-center text-light  mx-auto' 
       ...
       <input class="form-control " type="search" placeholder="Search for something" aria-label="Search" style={{width:'20%' ,marginLeft:'120px'}}  />  
        ...
        <div className="row mx-auto justify-content-center align-items-center ">
            <div className="col col-12 col-md-4">
                <div className="card" style={{width: "20rem"}}>
                    <img src={manspeaking} className="card-img-top" alt="..." style={{height:"30vh",}}/>
                </div>
            </div>

            <div className="col col-12 col-md-4">
                <div className="card" style={{width: "20rem"}}>
                    <img src={womanspeaking} className="card-img-top" alt="..." style={{height:"30vh",}}/>
                </div>
            </div>

            <div className="col col-12 col-md-4">
                <div className="card" style={{width: "20rem"}}>
                    <img src={youth} className="card-img-top" alt="..." style={{height:"30vh" ,}}/>
                </div>
            </div>
        </div>
    </div>
...
<div className="row row-cols-4 card-col container-fluid justify-content-center align-items-center" style={{margin: '0', padding: '0'}}>
    <div className="col col-img col-md-6 col-sm-12 col-lg-6 mt-5 d-flex flex-column justify-content-center align-items-center" style={{margin: '0', padding: '0'}}>
