...
<div className='container-fluid text-center mt-5'>
    ...
    <p style={{fontWeight:'700'}}>Help Educate And Support The Needy In The Community</p>

    <div className="row justify-content-center mt-5">
        <div className="col-lg-6 col-md-8 col-sm-10">
            <form style={{ boxShadow: '0 4px 8px 0 rgba(0,0,0,0.2)', maxWidth:'50rem', borderRight:'2px #000000 solid',borderBottom:'2px #000000 solid'}}> 
                <p style={{fontWeight:'900',  marginLeft: '20px'}}>YOUR DONATION</p>
                <hr style={{width:'50%', marginLeft:'150px'}} />
                <div className="mb-3">
                    <input type="text" className="form-control" id="name" placeholder="Amount" 
                        style={{
                            padding: '20px', 
                            maxWidth: '300px', 
                            marginLeft: '20px', 
                    ...
                    />
                    <select className="form-select mt-3 bg-dark text-light" id="currency" placeholder='select currency'
                        style={{
                            padding: '20px', 
                            maxWidth: '300px', 
                            marginLeft: '20px',  
