...
const  News_update = () =>{
  return (
    ...
    <div className="row justify-content-center align-items-center">
        ...
        {/* <img src={boys} alt="Logo" className="img-fluid rounded-start" style={{borderTopRightRadius:'40%', borderBottomLeftRadius:'40%',  maxHeight:'60vh'}} /> */}
        <img 
    src={boys} 
    alt="Logo" 
...
the society (widows, aged, critically ill)
</p>
