...
const About = () => {
  return (
    ...
    <div className="row justify-content-center align-items-center" style={{margin: '0', padding: '0'}}>
        ...
        {/* Image */}
        <div className="col-md-6 col-sm-12 col-lg-6 mt-5 d-flex flex-column  justify-content-center align-items-center" style={{margin: '0', padding: '0'}}>
    
            <img src={student} alt="Logo" className='img-fluid' style={{maxWidth:'100rem', height:'50vh', backgroundColor:'' }} />
